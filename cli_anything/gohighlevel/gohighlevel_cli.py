...
from cli_anything.gohighlevel.cli_extensions import register_foundation_commands
...
@click.version_option("0.1.0", prog_name="ghlcli")
@click.pass_context
...
register_foundation_commands(cli)
...
def contacts_remove_tag(ctx, contact_id, tags):
    ...
    try:
        data = api.delete(f"/contacts/{contact_id}/tags", data={"tags": list(tags)}, version=None)
